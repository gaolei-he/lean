...
// Module: Theorem.example_separate.Ico_pow_choose
...
LEAN_EXPORT lean_object* initialize_Theorem_example__separate_Ico__pow__choose(uint8_t builtin, lean_object* w) {
lean_object * res;
