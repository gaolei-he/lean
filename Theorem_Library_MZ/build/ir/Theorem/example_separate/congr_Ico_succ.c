...
// Module: Theorem.example_separate.congr_Ico_succ
...
LEAN_EXPORT lean_object* initialize_Theorem_example__separate_congr__Ico__succ(uint8_t builtin, lean_object* w) {
lean_object * res;
