...
// Module: Theorem.example_separate.sum_choose_eq_Ico
...
LEAN_EXPORT lean_object* initialize_Theorem_example__separate_sum__choose__eq__Ico(uint8_t builtin, lean_object* w) {
lean_object * res;
