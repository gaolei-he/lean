...
// Module: Theorem.mini_Theorem.succ_mul_choose_eq''
...
LEAN_EXPORT lean_object* initialize_Theorem_mini__Theorem_succ__mul__choose__eq_x27_x27(uint8_t builtin, lean_object* w) {
lean_object * res;
