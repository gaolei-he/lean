...
// Module: Theorem.example_separate.choose_mul_eq_mul_sub
...
LEAN_EXPORT lean_object* initialize_Theorem_example__separate_choose__mul__eq__mul__sub(uint8_t builtin, lean_object* w) {
lean_object * res;
