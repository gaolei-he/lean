...
// Module: Theorem.example_separate.two_mod_two_pow
...
LEAN_EXPORT lean_object* initialize_Theorem_example__separate_two__mod__two__pow(uint8_t builtin, lean_object* w) {
lean_object * res;
