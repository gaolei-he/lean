...
theorem choose_mul_add_pow_from_2_to_2(n l : ℕ)(x : ℝ)(h : l ≤ n)(k : ℕ)(hk : k ∈ Ico l (n + 1))(gol:  ↑(Nat.choose n k) * ↑(Nat.choose k l) = ↑(Nat.choose n l) * ↑(Nat.choose (n - l) (k - l))) :
   ↑(Nat.choose n k) * ↑(Nat.choose k l) = ↑(Nat.choose n l) * ↑(Nat.choose (n - l) (k - l)) := by
  rw [mem_Ico] at hk
  apply gol

theorem choose_mul_add_pow_from_2_to_3(n l : ℕ)(x : ℝ)(h : l ≤ n)(k : ℕ)(hk : k ∈ Ico l (n + 1))(gol:  ↑(Nat.choose n k * Nat.choose k l) = ↑(Nat.choose n l * Nat.choose (n - l) (k - l))) :
   ↑(Nat.choose n k) * ↑(Nat.choose k l) = ↑(Nat.choose n l) * ↑(Nat.choose (n - l) (k - l)) := by
  rw [mem_Ico] at hk
  rw [←cast_mul,←cast_mul]
  apply gol

theorem choose_mul_add_pow_from_3_to_3(n l : ℕ)(x : ℝ)(h : l ≤ n)(k : ℕ)(hk : l ≤ k ∧ k < n + 1)(gol:  ↑(Nat.choose n k * Nat.choose k l) = ↑(Nat.choose n l * Nat.choose (n - l) (k - l))) :
   ↑(Nat.choose n k) * ↑(Nat.choose k l) = ↑(Nat.choose n l) * ↑(Nat.choose (n - l) (k - l)) := by
  rw [←cast_mul,←cast_mul]
  apply gol

theorem choose_mul_add_pow_from_6_to_6(n l : ℕ)(x : ℝ)(h : l ≤ n)(k : ℕ)(hk : l ≤ k ∧ k < n + 1) :
   l ≤ k := by
  exact hk.left
