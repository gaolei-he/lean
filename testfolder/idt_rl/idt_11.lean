...
theorem choose_eq_choose_add'(h1:1 ≤ n)(h2:1 ≤ k) : choose n k = choose (n-1) (k-1) + choose (n-1) k := by lean_repl sorry
  have h3: choose n k = choose (n-1) k  + choose (n-1) (k-1) := by lean_repl sorry
