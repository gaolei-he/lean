...
theorem Idt36 {n k m : ℕ } (h1: k ≤ n) (h2 : 1 ≤ k - m) (h3 : m ≤ n)(h4 : 1 ≤ m): (∑ k in Icc 0 n,  (choose n k) * (descFactorial k m)) = (descFactorial n m) * 2 ^(n - m):= by lean_repl sorry
