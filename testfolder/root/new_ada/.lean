...
0theorem  Ico_choose_simp_0to1{n k: ℕ} (hkn : k ≤ n) (hsk : 1 ≤ k): ∑ k in Ico 0 (n.succ + 1), (-1:ℤ) ^ k * ↑k * (choose n.succ k) =
    ∑ k in Ico 1 (n.succ + 1), (-1:ℤ) ^ k * ↑k * (choose n.succ k):= by lean_repl sorry