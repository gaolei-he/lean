...
theorem idt22h10{n k: ℕ} (hkn : k ≤ n) (hsk : 1 ≤ k): ∑ k in Ico 1 (n.succ + 1), (-1:ℤ) ^ k * ↑k * ↑(Nat.choose (n.succ) k)
    = ∑ k in Ico 1 (n.succ + 1), (-1:ℤ) ^ k * n.succ * ↑(Nat.choose (n.succ - 1) (k - 1)) := by lean_repl sorry