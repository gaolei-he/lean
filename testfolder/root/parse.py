...
def split_theorems(file_path):
    ...
    # 确保输出目录存在
    output_dir = '/home2/wanglei/Project/testfolder/root/nat.prime'
...
# 指定要读取的Lean代码文件路径
input_file_path = '/home2/wanglei/Project/testfolder/ALL/nat.prime.lean'

# 分离定理并生成文件
split_theorems(input_file_path)
